...
def onclick():
    ...
    RATE = 16000
    RECORD_SECONDS = 2
    WAVE_OUTPUT_FILENAME = "pigis/pigis9.wav"
...
# compute lpcs
   ...
   # myLabel1 = Label(root,text=mean,bg="white" ,width ="65", height ="4").grid(row=3,column=1)
...
# compute lpcs
    ...
    myLabel2 = Label(root,text=mean,bg="white" ,width ="65", height ="4").grid(row=4,column=1)
def onclick2():
    CHUNK = 1024
    FORMAT = pyaudio.paInt16
    CHANNELS = 1
...
# compute lpcs
    ...
    myLabel3 = Label(root,text=mean,bg="white" ,width ="65", height ="4").grid(row=5,column=1)
...
# compute lpcs
    ...
    myLabel4 = Label(root,text=mean,bg="white" ,width ="65", height ="4").grid(row=6,column=1)
...
# compute lpcs
    ...
    myLabel5 = Label(root,text=mean,bg="white" ,width ="65", height ="4").grid(row=7,column=1)
...
# compute lpcs
    ...
    myLabel5 = Label(root,text=mean,bg="white" ,width ="65", height ="4").grid(row=8,column=1)
    
    
def myDelete():
    myLabel1 = Label(root,bg="white" ,width ="65", height ="4").grid(row=3,column=1).destroy()
    myLabel2 = Label(root,bg="white" ,width ="65", height ="4").grid(row=4,column=1).destroy()
def myDelete1():
    myLabel2 = Label(root,bg="white" ,width ="65", height ="4").grid(row=4,column=1).destroy()
def myDelete2():
      myLabel3 = Label(root,bg="white" ,width ="65", height ="4").grid(row=5,column=1).destroy()
def myDelete3():
      myLabel4 = Label(root,bg="white" ,width ="65", height ="4").grid(row=6,column=1).destroy()
def myDelete4():
     myLabel5 = Label(root,bg="white" ,width ="65", height ="4").grid(row=7,column=1).destroy()
def myDelete5():
     myLabel6 = Label(root,bg="white" ,width ="65", height ="4").grid(row=8,column=1).destroy()
     
#Top HeadeR
myLabel0 = Label(root, text="",width ="55",bg="red",height ="2").grid(row=0,column=0)
myLabel7 = Label(root, text="",width ="55",bg="grey",height ="2").grid(row=1,column=0)
myLabel8 = Label(root, text="",width ="55",bg="red",height ="2").grid(row=2,column=0)

myLabel0 = Label(root, text="",width ="65",bg="red",height ="2").grid(row=0,column=1)
myLabel7 = Label(root, text="",width ="65",bg="grey",height ="2").grid(row=1,column=1)
myLabel8 = Label(root, text="",width ="65",bg="red",height ="2").grid(row=2,column=1)
